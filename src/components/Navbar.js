      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <div className="dropdown mx-2">
                ...
                <ul
                  ...
                  <div className="row">
                    <button
                      type="button"
                      className="navItem  my-2 btn btn-primary"
                  ...
                  <div className="row">
                    <button
                      type="button"
                      className="navItem my-2 btn btn-success"
                  ...
                  <div className="row">
                    <button
                      type="button"
                      className="navItem my-2 btn btn-danger"
                  ...
                  <div className="row">
                    <button
                      type="button"
                      className="navItem  my-2 btn btn-warning"
                  ...
                  <div className="row">
                    <button
                      type="button"
                      className="navItem   my-2 btn btn-light"
                  ...
                  <div className="row">
                    <button
                      type="button"
                      className="navItem   my-2 btn btn-dark"
            ...
            <button onClick={handleLogout} className="navItem btn btn-primary">
              Logout
            </button>
          )}
        </div>
